    ...
    <div className="home-page">
      ...
      <section id="home" className="hero-section">
        ...
        <div className="hero-content animate-fade-up">
          <div className="hero-brand-logo">
            ...
            <div className="hero-brand-name">MS DANCEPIRATION</div>
          </div>
      ...
      <section id="gallery" className={`gallery-section ${isVisible.gallery ? 'animate-fade-up' : ''}`}>
        ...
        <div className="gallery-masonry">
          <img src="/images/hiphop.png" alt="Gallery" />
          <img src="/images/kids.png" alt="Gallery" />
          <img src="/images/bollywood.png" alt="Gallery" />
          <img src="/images/contemporary.png" alt="Gallery" />
          <img src="/images/hero.png" alt="Gallery" />
          <img src="/images/classical.png" alt="Gallery" />
        </div>
      </section>
